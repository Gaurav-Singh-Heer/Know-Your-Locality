  ...
  constructor() {
    ...
    if (config3.url) {
      const {
        ...
        hash,
        href
      } = parseUrl(config3.url, this._doc.location.origin);
...
var routes = [
  __spreadValues({ path: "", loadComponent: () => import("./chunk-3JIVPLRW.mjs").then((m) => m.LandingPage) }, true ? { \u0275entryName: "src/app/pages/landing/landing.ts" } : {}),
  __spreadValues({ path: "auth", loadComponent: () => import("./chunk-XQ24HOMA.mjs").then((m) => m.AuthPage) }, true ? { \u0275entryName: "src/app/pages/auth/auth.ts" } : {}),
  __spreadValues({ path: "preferences", loadComponent: () => import("./chunk-5DOM53AB.mjs").then((m) => m.PreferencesPage), canActivate: [authGuard] }, true ? { \u0275entryName: "src/app/pages/preferences/preferences.ts" } : {}),
  __spreadValues({ path: "dashboard", loadComponent: () => import("./chunk-DPKVRXOO.mjs").then((m) => m.DashboardPage), canActivate: [preferencesGuard] }, true ? { \u0275entryName: "src/app/pages/dashboard/dashboard.ts" } : {}),
  { path: "**", redirectTo: "" }
];
